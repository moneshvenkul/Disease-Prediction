...
l1=['stomach_pain','acidity','ulcers_on_tongue','vomiting','fatigue','weight_loss','restlessness','lethargy','irregular_sugar_level','cough','breathlessness','sweating','blurred_and_distorted_vision','chest_pain','obesity','excessive_hunger','muscle_weakness','stiff_neck','swelling_joints','movement_stiffness','increased_appetite','polyuria','painful_walking']

disease=['GERD','Diabetes','Heartattack','Arthritis']
...
df.replace({'prognosis':{'GERD':0,'Diabetes':1 ,'Heart attack':2,'Arthritis':3}},inplace=True)
...
tr.replace({'prognosis':{'GERD':0,'Diabetes':1 ,'Heart attack':2,'Arthritis':3}},inplace=True)
...
w2 = Label(root, justify=LEFT, text="Project done by Monesh Venkul", fg="white", bg="blue")
